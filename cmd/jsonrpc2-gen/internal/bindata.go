...
func tsGotemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "ts.gotemplate", size: 5949, mode: os.FileMode(420), modTime: time.Unix(1586617226, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
